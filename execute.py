...
# download data from S3 to instance
download_data(os.environ.get("FILENAME"), os.environ.get("BUCKETNAME"))

# run your query
polars_analysis(os.environ.get("FILENAME"), "output.txt")

# upload results back to S3 bucket
upload_data("output.txt", os.environ.get("BUCKETNAME"))
